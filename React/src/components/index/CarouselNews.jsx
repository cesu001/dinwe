      ...
      <div>
        ...
        >
          {this.state.carNews.map((carNew, index) => {
            return (
              <div className="card border-0 pic mt-4 mb-4 overflow-hidden" key={index}>
                <img src={carNew.image} className="card-img rounded-3 opacity-50" alt={carNew.resturant_name} style={{ height: "45vh" }} />
                <div className="row card-img-overlay justify-content-center">
                  ...
                  <p className="text-center"><a href={"http://localhost:3000/storeinformation/" + carNew.resturant_id}
                    className=" btn btn-warning border-dark opacity-75 text-decoration-none text-center fs-5"
                    style={{ width: "200px" }}
                  > 點擊前往</a></p>
