...
export default function Admin() {
  ...
  const [news, setNews] = useState([
    { id: 1, title: "壽星大八折", image: "https://picsum.photos/200/100?random=1", content: "88888", created_at: "2023-04-04", updated_at: "2023-04-04", state: 1 },
    { id: 2, title: "全新的遊樂設施", image: "https://picsum.photos/200/100?random=2", content: "88888", created_at: "2023-04-04", updated_at: "2023-04-04", state: 0 },
    {
      id: 1,
      resturant_id: 2,
      resturant_name: "沙拉嗑",
            ...
            <div className="collapse navbar-collapse " id="navbarSupportedContent">
              ...
              <ul className="navbar-nav mb-2 mb-lg-0 ">
                ...
                <li className="nav-item d-flex justify-content-center align-items-center ms-3">
                  <button className="text-white text-decoration-none btn btn-outline-secondary" onClick={handleLogout}>登出</button>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="tab-content">
              ...
              <div className="col-12 p-0 tab-pane mt-5 active" id="postnews">
                <div className="container">
                  ...
                  <div className="col-6 mx-auto mt-2 mb-5">
                    ...
                    <table className="table align-middle">
                      <thead>
                        <tr className='border-bottom border-black'>
                          ...
                          <th className='text-center'>是否上架</th>
                        </tr>
                      </thead>
                      <tbody>
                        {news.map((newItem, index) => {
                          return (
                            <tr className='' key={index}>
                              ...
                              <td className='text-center'><input type="checkbox" checked={newItem.state === 1 ? "checked" : ""} readOnly /></td>
                            </tr>
                          )
                        })}
                      </tbody>
